...
public class Piece_T extends Piece {
    ...
    static final int[][] MATRICE_0 = { {0,1}, {1,1}, {0,1} };
    static final int[][] MATRICE_1 = { {1,1,1}, {0,1,0} };
    static final int[][] MATRICE_2 = { {1,0}, {1,1}, {1,0} };
    static final int[][] MATRICE_3 = { {0,1,0}, {1,1,1} };
