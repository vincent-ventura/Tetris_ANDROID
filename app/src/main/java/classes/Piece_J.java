...
public class Piece_J extends Piece {
    ...
    static final int[][] MATRICE_0 = { {1,1}, {0,1}, {0,1} };
    static final int[][] MATRICE_1 = { {1,1,1}, {1,0,0} };
    static final int[][] MATRICE_2 = { {1,0}, {1,0}, {1,1} };
    static final int[][] MATRICE_3 = { {0,0,1}, {1,1,1} };


    public Piece_J() {
        super(HAUTEUR_DEPART, LARGEUR_DEPART, MATRICE_0, Color.rgb(223,109,20));
    }
